...
class StickerPack implements Parcelable {
    ...
    final int versionNumberOfImageData;
    ...
    StickerPack(String identifier, String name, String publisher, String trayImageFile, String publisherEmail, String publisherWebsite, String privacyPolicyWebsite, String licenseAgreementWebsite, int versionNumberOfImageData, boolean avoidCache) {
        ...
        this.versionNumberOfImageData = versionNumberOfImageData;
    ...
    protected StickerPack(Parcel in) {
        ...
        versionNumberOfImageData = in.readInt();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(versionNumberOfImageData);
