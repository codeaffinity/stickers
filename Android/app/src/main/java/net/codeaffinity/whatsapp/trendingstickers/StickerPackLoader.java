...
package net.codeaffinity.whatsapp.trendingstickers;
...
import static net.codeaffinity.whatsapp.trendingstickers.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static net.codeaffinity.whatsapp.trendingstickers.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static net.codeaffinity.whatsapp.trendingstickers.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
import static net.codeaffinity.whatsapp.trendingstickers.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static net.codeaffinity.whatsapp.trendingstickers.StickerContentProvider.PUBLISHER_EMAIL;
import static net.codeaffinity.whatsapp.trendingstickers.StickerContentProvider.PUBLISHER_WEBSITE;
import static net.codeaffinity.whatsapp.trendingstickers.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static net.codeaffinity.whatsapp.trendingstickers.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static net.codeaffinity.whatsapp.trendingstickers.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static net.codeaffinity.whatsapp.trendingstickers.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static net.codeaffinity.whatsapp.trendingstickers.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static net.codeaffinity.whatsapp.trendingstickers.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
